...
@testset "self-contained report" begin
    ...
    @test occursin("electrical-model-v1", html)
    ...
    @test occursin("Electrical detail", html)
    @test occursin("Switch contacts", html)
    @test occursin("Winding connections", html)
    @test occursin("Each winding retains its bus and terminals", html)
    ...
    @test occursin("single-svg-v2", html)
    ...
    @test !occursin("src=\"electrical-model.js\"", html)
    @test !occursin("src=\"layout/deterministic.js\"", html)
    @test !occursin("src=\"renderers/geospatial.js\"", html)
    @test !occursin("src=\"renderers/single-wire.js\"", html)
