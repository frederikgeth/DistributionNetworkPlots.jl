(function () {
  ...
  const complete = {
    ...
    bus: {
      source: { terminal_names: ["1", "2", "3", "n"], perfectly_grounded_terminals: ["n"], longitude: 153.020, latitude: -27.470 },
      feeder: { terminal_names: ["1", "2", "3", "n"], perfectly_grounded_terminals: ["n"], longitude: 153.030, latitude: -27.465 },
      load_bus: { terminal_names: ["1", "2", "3", "n"], perfectly_grounded_terminals: ["n"], longitude: 153.040, latitude: -27.460 },
      aux_bus: { terminal_names: ["1", "2", "3", "n"], perfectly_grounded_terminals: ["n"], longitude: 153.050, latitude: -27.455 }
    },
    ...
    line_geometry: { route_main: { coordinates: [[153.020, -27.470], [153.025, -27.468], [153.030, -27.465]] } },
    transformer: {
  ...
  const partial = {
    ...
    meta: { license: "CC-BY-4.0", attribution: "DistributionNetworkPlots.jl contributors", source: "authored in this repository", case_study_generator: "built-in browser example" },
    bus: {
      substation: { terminal_names: ["1", "2", "3", "n"], perfectly_grounded_terminals: ["n"], longitude: 153.060, latitude: -27.450 },
      branch: { terminal_names: ["1", "2", "3", "n"] },
      remote: { terminal_names: ["p", "n"] }
    },
