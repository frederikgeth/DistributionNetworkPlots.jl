(function () {
  ...
  function createGeospatialRenderer(dependencies) {
    ...
    function drawGeo() {
      ...
      renderVoltageControls(); refresh(); renderMembers(); renderLandmarkList(); renderOperatingEvidence();
    }
